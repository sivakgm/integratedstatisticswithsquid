...
/* The install prefix */
#define DEFAULT_PREFIX /usr/local/updatestat
...
#define PACKAGE_STRING "Squid Web Proxy 3.4.6"
...
#define SQUID_CONFIGURE_OPTIONS " '--prefix=/usr/local/updatestat/' --enable-ltdl-convenience"

/* UDP receive buffer size */
#define SQUID_DETECT_UDP_SO_RCVBUF 124928

/* UDP send buffer size */
#define SQUID_DETECT_UDP_SO_SNDBUF 124928
